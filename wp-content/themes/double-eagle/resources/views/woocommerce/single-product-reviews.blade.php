...
?>
<div id="reviews" class="woocommerce-Reviews w-100 bg-secondary rip-top--1">
	...
	<div id="comments" class="container">
		...
		{{-- section controls leaving a review --}}

		<div class="d-flex align-items-center">
			<div class="flex-grow-1 d-flex align-items-center">
				@if ($average = $product->get_average_rating())
					<div class="star-rating average" title="{{sprintf(__( 'Rated %s out of 5', 'woocommerce' ), $average)}}">
						<span style="width: {{( $average / 5 ) * 100 }}'%">
							<strong itemprop="ratingValue" class="rating">
								{{$average}}
							</strong> {{__( 'out of 5', 'woocommerce' )}}
						</span>
					</div>
					<p>{{ wp_count_comments( $product->get_ID() )->total_comments }} 
						REVIEWS
					</p>
				@endif
		...
		<div class="collapse" id="collapseReviews">
			<div class="card card-body mt-3">
				<?php if ( get_option( 'woocommerce_review_rating_verification_required' ) === 'no' || wc_customer_bought_product( '', get_current_user_id(), $product->get_id() ) ) : ?>
					<div id="review_form_wrapper" class="p-4">
						<div id="review_form">
							<?php
		...
		{{-- end of leaving a review section --}}

		<?php if ( have_comments() ) : ?>
			<ol class="commentlist p-0 pl-md-4">
