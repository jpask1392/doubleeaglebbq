...
<form class="woocommerce-cart-form" action="{{ wc_get_cart_url() }}" method="post">
	...
	<table class="shop_table shop_table_responsive cart woocommerce-cart-form__contents" cellspacing="0">
		<thead>
			<tr>
                <th class="product-name"><h4><?php esc_html_e( 'Product', 'woocommerce' ); ?></h4></th>
				...
				<th class="product-subtotal"><h4><?php esc_html_e( 'Subtotal', 'woocommerce' );  ?></h4></th>
			</tr>
		</thead>
		<tbody>
					...
					<tr class="woocommerce-cart-form__cart-item <?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
                        ...
                        <td class="product-quantity" data-title="<?php esc_attr_e( 'Quantity', 'woocommerce' ); ?>">
                            ...
                            if ( $_product->is_sold_individually() ) {
                                $product_quantity = sprintf( '1 <input type="number" step="1" name="cart[%s][qty]" value="1" />', $cart_item_key );
                            } else {
